...
cd ../../../..
cd frameworks/av
git apply -v ../../device/blackview/alifep1pro/patches/framework_av/0001-libmedia-stub-out-MTK-specific-bits-audio-working.patch
git apply -v ../../device/blackview/alifep1pro/patches/framework_av/0002-camera.patch
git apply -v ../../device/blackview/alifep1pro/patches/framework_av/0003-frameworks_av_fmradio_patch.patch
git apply -v ../../device/blackview/alifep1pro/patches/framework_av/0001_engineering_mode_audio_settings_frameworks_av.patch
cd ../..
cd frameworks/base
git apply -v ../../device/blackview/alifep1pro/patches/framework_base/0001-location-support-GNSS-extension-presumably-from-MTK.patch
git apply -v ../../device/blackview/alifep1pro/patches/framework_base/0002-location-add-some-logs-just-to-be-confident.patch
...
git apply -v ../../device/blackview/alifep1pro/patches/hardware_libhardware/0001_engineering_mode_audio_settings_hardware_libhardware.patch
cd ../..
cd hardware/libhardware_legacy
git apply -v ../../device/blackview/alifep1pro/patches/hardware_libhardware_legacy/patch-for-mtk.patch
cd ../..
